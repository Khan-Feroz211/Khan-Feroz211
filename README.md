<!-- ============================================================ -->
<!-- DESIGN DIRECTION: "Terminal Ember"                            -->
<!-- Background:  #0D1117   |   Accent (dominant): #F97316         -->
<!-- Text:        #E6EDF3   |   Font: Fira Code (typing SVG)       -->
<!-- ============================================================ -->
...
AI Engineer and Full-Stack Developer (Computer Science student at NUTECH, expected Dec 2028) building production backend and AI/LLM systems for real users, not classroom projects. Focused on Claude API integration, Retrieval-Augmented Generation (RAG) pipelines, and FastAPI backends that run at scale with strict latency and uptime targets.

```bash
ROLE     : AI Engineer & Full-Stack Developer
EXP      : 6 months production experience (ADRAK Digital)
DOMAIN   : Enterprise AI automation, backend infrastructure, client-facing AI systems
STACK    : Python, FastAPI, TypeScript, Claude API, n8n, PostgreSQL, Docker
OPEN_TO  : SWE/AI Engineering internships, full-time AI/ML or full-stack roles,
           freelance backend + automation contracts, LLM research collaboration
```
...
|---|---|---|
| AI/LLM Integration | Production | Claude API, prompt engineering, RAG pipelines, AI agents |
| Backend Engineering | Production | FastAPI, Python, REST APIs, PostgreSQL at scale |
| Workflow Automation | Production | n8n-based automation, Claude API–driven pipelines |
| Auth & Security | Applied | OAuth 2.0, JWT token management |
| Databases | Applied | PostgreSQL, connection pooling, DBMS fundamentals |
| TypeScript Systems | Applied | TypeScript-based application development |

<br/>

### `$ ls ./projects --featured`

> No personal/open-source projects were provided for this section — see note at the end of this message. Add your repos here in the same `<details>` format once you share them:
...
| Stack | Scale | Impact |
|---|---|---|
| e.g. FastAPI, PostgreSQL | e.g. X req/day | e.g. Y% improvement |

One-line description of what the project does and your role in building it.
...
<details open>
<summary><b>ADRAK Digital — AI-Automation & Backend Developer</b> <code>Jan 2026 – Jun 2026</code></summary>
<br/>

- Engineered 8+ AI-powered automation workflows using Claude API + n8n, reducing manual data processing by 70% for enterprise clients
- Built 5+ production-grade FastAPI backends handling 10,000+ daily API requests at <100ms average latency with 99.9% uptime
- Built Retrieval-Augmented Generation (RAG) systems for client-specific knowledge bases, cutting support queries by 45%
...
| Metric | Result |
|---|---|
| AI automation workflows shipped | 8+ production workflows |
| Manual processing reduction | 70% for enterprise clients |
| Daily API requests handled | 10,000+ at <100ms avg latency |
| System uptime | 99.9% |
| Support query reduction via RAG | 45% |
| Enterprise clients managed | 3+ |
| Time to promotion | Promoted to core technical resource in 4 months |
...
> No coding platform handles (LeetCode / HackerRank / GFG) were provided — skipped per instructions.
...
<img src="https://raw.githubusercontent.com/Khan-Feroz211/Khan-Feroz211/output/github-contribution-grid-snake-dark.svg" />
...
```yaml
learning:
  - Machine learning fundamentals: model architectures, fine-tuning, evaluation
building:
  - Production FastAPI backends and Claude API / LLM-powered automation
exploring:
  - RAG evaluation methods and agentic workflow reliability   # confirm exact angle
open_to:
